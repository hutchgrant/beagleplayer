...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon May 14 06:46:16 2012
...
SOURCES       = src/syncall.cpp \
		...
		src/volume.cpp \
		src/dbconnect.cpp \
		src/newplaylist.cpp moc_syncall.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/beagleplayer1.0.0/ && $(COPY_FILE) --parents src/syncall.h src/qmpyuvreader.h src/qmpwidget.h src/playlist.h src/localsync.h src/fileobj.h src/controls.h src/browse.h src/beaglemain.h src/preferences.h src/prefdialog.h src/about.h src/volume.h src/dbconnect.h src/newplaylist.h .tmp/beagleplayer1.0.0/ && $(COPY_FILE) --parents res/BTres.qrc .tmp/beagleplayer1.0.0/ && $(COPY_FILE) --parents src/syncall.cpp src/qmpwidget.cpp src/playlist.cpp src/main.cpp src/localsync.cpp src/fileobj.cpp src/controls.cpp src/browse.cpp src/beaglemain.cpp src/preferences.cpp src/prefdialog.cpp src/about.cpp src/volume.cpp src/dbconnect.cpp src/newplaylist.cpp .tmp/beagleplayer1.0.0/ && $(COPY_FILE) --parents src/playlist.ui src/controls.ui src/browse.ui src/beaglemain.ui src/prefdialog.ui src/about.ui src/volume.ui src/newplaylist.ui .tmp/beagleplayer1.0.0/ && (cd `dirname .tmp/beagleplayer1.0.0` && $(TAR) beagleplayer1.0.0.tar beagleplayer1.0.0 && $(COMPRESS) beagleplayer1.0.0.tar) && $(MOVE) `dirname .tmp/beagleplayer1.0.0`/beagleplayer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/beagleplayer1.0.0
...
compiler_moc_header_make_all: moc_syncall.cpp moc_qmpyuvreader.cpp moc_qmpwidget.cpp moc_playlist.cpp moc_controls.cpp moc_browse.cpp moc_beaglemain.cpp moc_prefdialog.cpp moc_about.cpp moc_volume.cpp moc_newplaylist.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_syncall.cpp moc_qmpyuvreader.cpp moc_qmpwidget.cpp moc_playlist.cpp moc_controls.cpp moc_browse.cpp moc_beaglemain.cpp moc_prefdialog.cpp moc_about.cpp moc_volume.cpp moc_newplaylist.cpp
moc_syncall.cpp: src/localsync.h \
		src/fileobj.h \
		src/dbconnect.h \
		src/preferences.h \
		src/prefdialog.h \
		src/syncall.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/syncall.h -o moc_syncall.cpp
...
syncall.o: src/syncall.cpp src/syncall.h \
		src/localsync.h \
		src/fileobj.h \
		src/dbconnect.h \
		src/preferences.h \
		src/prefdialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o syncall.o src/syncall.cpp
...
moc_syncall.o: moc_syncall.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_syncall.o moc_syncall.cpp
...
install_other: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/skynet/Desktop/beagleplayer/beagleplayer $(INSTALL_ROOT)/opt/extras.ubuntu.com/beagleplayer/release/
